...
const Header = () => {
    return (
     ...
     <a href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-sm text-grey-500 m-auto md:m-0 hover:scale-105 transition-all duration-300'>
