    ...
    <div className="px-6 sm:px-8 md:px-12 py-10 bg-primary text-white rounded-lg shadow-md">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start md:justify-between gap-6 md:gap-10">
        ...
        <div className="flex-1 text-base leading-relaxed text-center md:text-left">
          <p className="mb-4">
            <strong>Prescripto</strong> is a modern and user-friendly platform designed to connect patients with trusted doctors for seamless appointment booking. Whether you’re seeking specialized medical care or need a quick consultation, Prescripto simplifies the process by offering a comprehensive directory of highly qualified doctors across various specialties.
          </p>
